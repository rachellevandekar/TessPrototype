...
public class ablatieActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        videoView.setVideoURI(Uri.parse("android.resource://"+getPackageName()+"/"+R.raw.tessablatie));
        // playAudio();
        videoView.start();
        ...
        timer.schedule(new TimerTask() {
            ...
            public void run() {
                ...
                Intent intent = new Intent (ablatieActivity.this, herhalingAblatieActivity.class);
